...
@Composable
fun EditRecurringMonthlyTransactionRoute(
    transactionId: Long,
    onBackClick: () -> Unit,
    onSaved: (Long) -> Unit,
    viewModel: EditRecurringMonthlyTransactionViewModel = viewModel(
    ...
    EditRecurringMonthlyTransactionScreen(
        uiState = uiState,
...
@Composable
fun EditRecurringMonthlyTransactionScreen(
    uiState: EditRecurringMonthlyTransactionUiState,
    onBackClick: () -> Unit,
...
@Composable
private fun EditRecurringMonthlyTransactionScreenPreview() {
    FixedExpenesesTheme {
        EditRecurringMonthlyTransactionScreen(
            uiState = EditRecurringMonthlyTransactionUiState(
                id = 1,
